...
dnevno_stevilo_testiranj_linija <- ggplot(rutinsko.testiranje, aes(x=datum,y=dnevno.stevilo.testiranj)) +
  geom_line(col="red")+geom_smooth(col="red") + ggtitle("Dnevno število testiranj v Sloveniji")
