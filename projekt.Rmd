...
```{r point, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Tekme brez prejetega zadetka'}
...
```{r point2, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Iztekanja'}
