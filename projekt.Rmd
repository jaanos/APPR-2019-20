...
Iz grafa se razbere, da se je testiranje do sredine aprila povečevalo, nato pa je začelo padati, juninja pa se je zopet povečalo.

##################################################################################

Spodnji graf prikazuje vsa skupna testiranja 
...
{r dnevno_stevilo_testiranj_delovni_dan, echo=FALSE, message=FALSE, fig.align='center', warning = FALSE}
print(dnevno_stevilo_testiranj_delovni_dan)

Iz grafa je jasno razvidno, da je število testiranj čez vikend pade.
...
Iz grafa se razbere, da občutne razlike med spoloma ni, saj se približek za število okuženih prekriva.

######################################################################################

Spodnji graf prikazuje odstotek pozitivnih testov
...
Na histogramu se vidi, da med pogostostjo okužb in število pozitivnih testov velja obratno sorazmerje.
...
Iz grafa razberemo, da število prekuženost v Evropi narašča logaritimično medtem pa v ZDA narašča eksponentno.
...
Zemljevid svetovne prekuženosti 5.5.2020
...
Iz grafa razberremo, da Severna Amerika in Evropa testirata občunto več, kot Azija. Razlika je še tako večja glede na števillo prebivalcev celine. Na grafu se vidi tudi to, da v Evropi testiranje čez vikend močno upade, zanimivo je, da je to pojav, ki se na drugih celinah ne dogaja.
