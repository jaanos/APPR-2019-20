...
```{r, echo=FALSE, message=FALSE}
  ...
  #Tabela_skupna <- Tabela_skupna[ , !names(Tabela_skupna) %in% c("Osamosvojitev")] #odstranimo en stolpec, da vrne lepo tabelo
