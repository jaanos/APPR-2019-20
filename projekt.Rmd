...
2. `Kolicina` - podatki o kolicina alkohola za leto 2010 po države
  ...
  - `Females` - meritev: število konzumacija ženskega pola (numeric),
  - `Males` - meritev: število konzumacija maškega pola (numeric),
  - `Total` - meritev: število konzumacija skupaj (numeric).
